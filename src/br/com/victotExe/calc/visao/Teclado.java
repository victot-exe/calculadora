...
public class Teclado extends JPanel implements ActionListener{
	...
	public Teclado() {
		...
		c.weightx = 1;
		c.weighty = 1;
//		faz a constrain setar o botão para preencher o espaço necessário de ambos os lados
		c.fill = GridBagConstraints.BOTH;
		
		//linha 1
		adicionarBotao("AC", COR_CINZA_ESCURO, c, 0, 0);
		adicionarBotao("+/-", COR_CINZA_ESCURO, c, 1, 0);//caractere q representa o +/- ao mesmo tempo
